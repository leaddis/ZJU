...
#
# @modified by Haoyang Liu, 2021.02.08
#
###
#
...
if (LAPACK_FOUND)
  ...
  if (NOT LAPACKE_STANDALONE)
    ...
    if(LAPACKE_WORKS)
      ...
      # find lapacke.h
      # not an error if lapacke.h is not found.
      unset(_inc_dir CACHE)
      find_path(_inc_dir
          NAMES lapacke.h
          PATH_SUFFIXES include openblas/include OpenBLAS openblas)
      if (_inc_dir)
          set(LAPACKE_INCLUDE_DIRS "${_inc_dir}")
          set(LAPACKE_INCLUDE_DIRS_DEP "${_inc_dir}")
      else()
          message(WARNING "lapacke.h not found in default location. Please set CFLAGS/CXXFLAGS when compiling")
  ...
  if (LAPACKE_STANDALONE OR NOT LAPACKE_WORKS)
    ...
    if(NOT LAPACKE_WORKS AND NOT LAPACKE_FIND_QUIETLY)
      message(STATUS "Looking for lapacke : test with lapack fails, switch to standalone lapacke")
    endif()
