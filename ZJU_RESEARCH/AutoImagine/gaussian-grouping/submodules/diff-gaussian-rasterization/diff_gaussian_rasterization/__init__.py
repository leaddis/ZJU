...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, objects, radii, geomBuffer, binningBuffer, imgBuffer, maxTrans = _C.rasterize_gaussians(*args)
            ...
            num_rendered, color, objects, radii, geomBuffer, binningBuffer, imgBuffer, maxTrans = _C.rasterize_gaussians(*args)
        # maxTrans: maximum opacity of each gaussian observed by pixels in the mask from a certain frame
        ...
        return color, radii, objects, maxTrans

    @staticmethod
    def backward(ctx, grad_out_color, grad_radii, grad_out_objects, maxTrans):
...
class GaussianRasterizer(nn.Module):
    ...
    def forward(self, means3D, means2D, opacities, alpha, shs = None, sh_objs = None, colors_precomp = None, scales = None, rotations = None, cov3D_precomp = None):
